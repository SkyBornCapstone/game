...
namespace PurrNet.Modules
{
    ...
    {
        [JsonProperty] public PlayerID playerId { get; }

        [JsonProperty] public NetworkID lastNidId { get; }
    ...
    public struct PlayerJoinedEvent : IPackedAuto
    {
        ...
        [JsonProperty] public Connection connection { get; }

        [JsonProperty] public NetworkID? lastNidId { get; }

        [JsonProperty] public string cookie { get; }
    ...
    {
        [JsonProperty] public DisposableList<PlayerJoinedEvent> events { get; }
