...
namespace PurrNet.Modules
{
    ...
    public struct RPCPacketPacker
    {
        ...
        [UsedByIL]
        public static RPCPacketPacker CreateStaticWithInfo(NetworkManager manager, StaticRPCPacket context,
            RPCInfo info)
        {
        ...
        [UsedByIL]
        public static RPCPacketPacker Create(NetworkManager manager, RPCPacket context, RPCSignature signature,
            PlayerID target)
        {
            if (!manager)
        ...
        [UsedByIL]
        public static RPCPacketPacker CreateStatic(NetworkManager manager, StaticRPCPacket context,
            RPCSignature signature, PlayerID target)
        {
            if (!manager)
                throw new InvalidOperationException("NetworkManager is not initialized.");
        ...
        [UsedByIL]
        public static RPCPacketPacker CreateChild(NetworkManager manager, ChildRPCPacket context,
            RPCSignature signature, PlayerID target)
        {
            if (!manager)
                throw new InvalidOperationException("NetworkManager is not initialized.");
