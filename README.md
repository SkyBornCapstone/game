...
![Skyborn Ship Hero Image](ship_image.png)
...
* **Melee Combat:** Smooth sword fighting combat where crews must coordinate to defeat enemy pirates that defend treasure on the islands.
...
* **Adaptive Audio Engine:** The game features immersive sound effects and a reactive music system that smoothly crossfades between an exploratory background song and a combat song.
...
1. **Download the Source Code**: Clone or download the repository from our GitHub page.
...
**Feedback & Issues:** Found a bug or have a suggestion? Please open an issue on our GitHub repository!

---

## Meet the Crew (Group 10 - CS.010)

* **[Taz Larson](https://github.com/ttlarson7)** - Combat, Modeling, Ship Controls
* **[Will Teyema](https://github.com/PotatoPresident)** - Networking, Game States, Performance
* **[Michael Pflaging](https://github.com/michael-pflaging)** - World Generation, Music, Sound Effects
